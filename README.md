...
- Your PR/submission should contain all the materials in your school's folder
...
We utilize Github workflow CI jobs to scan the added files to make sure they comply with our requirements.

We will not start reviewing a PR until all CI jobs are passing, so after you create the pull request verify that all the jobs pass.
